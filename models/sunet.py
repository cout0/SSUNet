...
class SpikingUnet(Module):
    def __init__(self, color=False, stbp=False, reset_method='reduce_by_zero'):
        ...
        self.relu1              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu2              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu3              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu4              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu5              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu6              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu7              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu8              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu9              = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu10             = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu_convtranpose1 = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu11             = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu12             = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu_convtranpose2 = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu13             = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu14             = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu_convtranpose3 = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu15             = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu16             = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu_convtranpose4 = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu17             = neuron.IFNode(surrogate_function=surrogate.ATan())
        self.relu18             = neuron.IFNode(surrogate_function=surrogate.ATan())
