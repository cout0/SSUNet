...
class CellDataset(Dataset):
    ...
    def __init__(
        ...
        pct=.9, data_type='train', in_size=572, out_size=512,
        ...
        path = os.path.join(self.root_dir, 'data/ISBI_2012_EM')
...
if __name__ == '__main__':
    ...
    mean = 0.495
    std = 0.173
    dataloader = get_dataloader(mean, std, 512, 2)
